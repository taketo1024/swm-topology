...
class SimplicialCohomologyTests: XCTestCase {
    ...
    func testD3_Z() {
        ...
        let H = SimplicialCohomology<𝐙>(K)
    ...
    func testD3_S2_Z() {
        let K = SimplicialComplex.ball(dim: 3)
        let L = K.skeleton(2)
        let H = SimplicialCohomology<𝐙>(K, relativeTo: L)
    ...
    func testD3_Z2() {
        let K = SimplicialComplex.ball(dim: 3)
        let H = SimplicialCohomology<𝐅₂>(K)
    ...
    func testD3_S2_Z2() {
        let K = SimplicialComplex.ball(dim: 3)
        let L = K.skeleton(2)
        let H = SimplicialCohomology<𝐅₂>(K, relativeTo: L)
    ...
    func testD3_Q() {
        let K = SimplicialComplex.ball(dim: 3)
        let H = SimplicialCohomology<𝐐>(K)
    ...
    func testD3_S2_Q() {
        let K = SimplicialComplex.ball(dim: 3)
        let L = K.skeleton(2)
        let H = SimplicialCohomology<𝐐>(K, relativeTo: L)
